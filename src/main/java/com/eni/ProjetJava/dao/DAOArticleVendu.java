...
public class DAOArticleVendu implements IDAOArticleVendu {
    ...
    public DAOArticleVendu(){
        articleVendus.add(new ArticleVendu("1", "Toto", "Desription Toto", LocalDate.of(2025, 4, 15), LocalDate.of(2025, 4, 30), 20, 30, "bon", categorie1, retrait));
        articleVendus.add(new ArticleVendu("2", "Chocolatine", "Desription Chocolatine", LocalDate.of(2025, 5, 7), LocalDate.of(2025, 5, 15), 10, 40, "mauvais", categorie2, retrait));
        articleVendus.add(new ArticleVendu("3", "Beurre Doux", "Desription Beurre Doux", LocalDate.of(2025, 4, 30), LocalDate.of(2025, 5, 6), 7, 12, "bon", categorie3, retrait));
    }
